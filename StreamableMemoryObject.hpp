...
//
//                     The AKJ Compiler Infrastructure
//
...
class StreamableMemoryObject : public MemoryObject {
 public:
  ...
  virtual uint64_t getBase() const AKJ_OVERRIDE = 0;
  ...
  virtual uint64_t getExtent() const AKJ_OVERRIDE = 0;
  ...
  virtual int readByte(uint64_t address, uint8_t *ptr) const AKJ_OVERRIDE = 0;
  ...
  virtual int readBytes(uint64_t address,
                        uint64_t size,
                        uint8_t *buf) const AKJ_OVERRIDE = 0;
...
public:
  ...
  virtual uint64_t getBase() const AKJ_OVERRIDE { return 0; }
  virtual uint64_t getExtent() const AKJ_OVERRIDE;
  virtual int readByte(uint64_t address, uint8_t *ptr) const AKJ_OVERRIDE;
  virtual int readBytes(uint64_t address,
                        uint64_t size,
                        uint8_t *buf) const AKJ_OVERRIDE;
  virtual const uint8_t *getPointer(uint64_t address,
                                    uint64_t size) const AKJ_OVERRIDE {
  ...
  virtual bool isValidAddress(uint64_t address) const AKJ_OVERRIDE;
  virtual bool isObjectEnd(uint64_t address) const AKJ_OVERRIDE;
...
private:
  ...
  StreamingMemoryObject(const StreamingMemoryObject&) AKJ_DELETED_FUNCTION;
  void operator=(const StreamingMemoryObject&) AKJ_DELETED_FUNCTION;
};
