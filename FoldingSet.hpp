...
/// than using plain FoldingSetNodeIDs, since the 32-element cSmallVector
...
class FoldingSetNodeID {
  ...
  /// Use a cSmallVector to avoid a heap allocation in the common case.
  cSmallVector<unsigned, 32> Bits;
...
public:
  ...
  void AddString(cStringRef String);
...
///   void Profile(akj::FoldingSetNodeID &, Ctx);
...
template <class T, class VectorT = cSmallVector<T*, 8> >
